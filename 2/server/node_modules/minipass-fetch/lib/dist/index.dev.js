  ...
  return new Promise(function (resolve, reject) {
    ...
    req.on('response', function (res) {
      ...
      if (fetch.isRedirect(res.statusCode)) {
        ...
        var locationURL = location === null ? null : resolveUrl(request.url, location); // HTTP fetch step 5.5
      ...
      var body = new Minipass(); // exceedingly rare that the stream would have an error,
      ...
      if (codings == 'deflate' || codings == 'x-deflate') {
        ...
        raw.once('data', function (chunk) {
          ...
          var decoder = (chunk[0] & 0x0F) === 0x08 ? new zlib.Inflate() : new zlib.InflateRaw(); // exceedingly rare that the stream would have an error,
          // but just in case we proxy it to the stream in use.
