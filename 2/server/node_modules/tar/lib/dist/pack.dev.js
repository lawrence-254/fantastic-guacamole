...
function (_Minipass) {
  ...
  function Pack(opt) {
    ...
    if (opt.gzip || opt.brotli) {
      ...
      if (opt.brotli) {
        if (_typeof(opt.brotli) !== 'object') {
          opt.brotli = {};
        }

        _this.zip = new zlib.BrotliCompress(opt.brotli);
      }
  ...
  _createClass(Pack, [{
    ...
    value: function value(p) {
      ...
      var absolute = normPath(path.resolve(this.cwd, p.path)); // in this case, we don't have to wait for the stat
