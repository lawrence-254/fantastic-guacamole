...
if (rc.runtime === 'electron' && rc.target[0] === '4' && rc.abi === '64') {
  log.error("Electron version ".concat(rc.target, " found - skipping prebuild-install work due to known ABI issue"));
...
var startDownload = function startDownload(downloadUrl) {
