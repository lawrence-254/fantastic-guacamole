...
function poison(object, property) {
  function fail() {
    console.error(Error("Property ".concat(property, " should not have been accessed.")));
    process.abort();
  }
...
TestPythonFinder.prototype = Object.create(PythonFinder.prototype); // Silence npmlog - remove for debugging
...
test('find python - no python, no python launcher, good guess', function (t) {
  ...
  var f = new TestPythonFinder(null, done);
  f.win = true;
  var expectedProgram = f.winDefaultLocations[0];
