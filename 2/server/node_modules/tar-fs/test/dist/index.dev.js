...
test('strip + map', function (t) {
  ...
  var uppercase = function uppercase(header) {
...
test('map + dir + permissions', function (t) {
  ...
  var aWithMode = function aWithMode(header) {
    if (header.name === 'a') {
...
test('check type while mapping header on packing', function (t) {
  ...
  var checkHeaderType = function checkHeaderType(header) {
...
test('finish callbacks', function (t) {
  ...
  var countPackEntry = function countPackEntry(header) {
    packEntries++;
  };

  var countExtractEntry = function countExtractEntry(header) {
    extractEntries++;
  };

  var pack;

  var onPackFinish = function onPackFinish(passedPack) {
  ...
  var onExtractFinish = function onExtractFinish() {
...
test('not finalizing the pack', function (t) {
  ...
  var prefixer = function prefixer(prefix) {
