'use strict'; // Copyright (c) 2018 inspiredware
...
exports.packageSupportsVersion = function (napiVersion) {
  if (pkg.binary && pkg.binary.napi_versions && pkg.binary.napi_versions instanceof Array) {
...
exports.logMissingNapiVersions = function (target, prebuild, log) {
  if (exports.getNapiBuildVersions()) {
    ...
    log.error('Builds with runtime \'napi\' require a binary.napi_versions ' + 'property on the package.json file');
  }
};
/**
...
var prebuildExists = function prebuildExists(prebuild, napiVersion) {
  if (prebuild) {
...
exports.getBestNapiBuildVersion = function () {
  ...
  if (napiBuildVersions) {
    ...
    napiBuildVersions.forEach(function (napiBuildVersion) {
      if (napiBuildVersion > bestNapiBuildVersion && napiBuildVersion <= ourNapiVersion) {
...
exports.getNapiBuildVersions = function () {
  var napiBuildVersions = []; // remove duplicates, convert to text
